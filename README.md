...
This project is a strong demo — but if questioned deeply, you must be ready to answer:

- Is the RSA attack a real implementation or a simulation?  
- Are you using real Kyber libraries or simplified logic?  
- How is key exchange handled internally?  
- What are the performance and security guarantees?  

### To Make It Next-Level:

- Integrate real PQC libraries (e.g., liboqs)  
- Add benchmarking (RSA vs Kyber)  
- Show architecture diagrams  
- Add attack models and comparisons  

---

## 🌍 Future Improvements

- Real PQC library integration  
- Performance benchmarking dashboard  
- Multi-user chat using WebSockets  
